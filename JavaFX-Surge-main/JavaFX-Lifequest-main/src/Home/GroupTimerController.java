 ...
 * @author USER
 */
public class GroupTimerController implements Initializable {
...
//    String start_Act = StartController.getAct();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        hours = GroupActController.getHours();

        minutes = GroupActController.getMinutes();
...
//                        PreparedStatement ps2;
                        try {
                            ...
                            if (GroupMemController.getM1() != null) {
                                sql = "SELECT `bonus_xp` FROM `user` WHERE `users` = ?";
                                ps1 = con.prepareStatement(sql);
                                ps1.setString(1, GroupMemController.getM1());

                                rs1 = ps1.executeQuery();
                                rs1.next();
                                bonus_total_xp = Double.parseDouble(rs1.getString(1)) + xp_gained;

                                sql2 = "UPDATE `user` SET `bonus_xp` = ? WHERE `users` = ?";
                                ps2 = con.prepareStatement(sql2);
                                ps2.setString(1, Double.toString(bonus_total_xp));
                                ps2.setString(2, GroupMemController.getM1());

                                ps2.executeUpdate();

                                //updating total xp column of main table
                                sql3 = "SELECT `total_XP` FROM `user` WHERE `users` = ?";
                                ps3 = con.prepareStatement(sql3);
                                ps3.setString(1, GroupMemController.getM1());

                                rs2 = ps3.executeQuery();
                                rs2.next();
                                new_total_xp = Double.parseDouble(rs2.getString(1)) + xp_gained;

                                sql4 = "UPDATE `user` SET `total_XP` = ? WHERE `users` = ?";
                                ps4 = con.prepareStatement(sql4);
                                ps4.setString(1, Double.toString(new_total_xp));
                                ps4.setString(2, GroupMemController.getM1());
                             ...
                             if (GroupMemController.getM2() != null) {
                                sql = "SELECT `bonus_xp` FROM `user` WHERE `users` = ?";
                                ps1 = con.prepareStatement(sql);
                                ps1.setString(1, GroupMemController.getM2());
                                ...
                                ps2 = con.prepareStatement(sql2);
                                ps2.setString(1, Double.toString(bonus_total_xp));
                                ps2.setString(2, GroupMemController.getM2());
                                ...
                                sql3 = "SELECT `total_XP` FROM `user` WHERE `users` = ?";
                                ps3 = con.prepareStatement(sql3);
                                ps3.setString(1, GroupMemController.getM2());
                                ...
                                ps4 = con.prepareStatement(sql4);
                                ps4.setString(1, Double.toString(new_total_xp));
                                ps4.setString(2, GroupMemController.getM2());
                              ...
                              if (GroupMemController.getM3() != null) {
                                sql = "SELECT `bonus_xp` FROM `user` WHERE `users` = ?";
                                ps1 = con.prepareStatement(sql);
                                ps1.setString(1, GroupMemController.getM3());
                                ...
                                ps2 = con.prepareStatement(sql2);
                                ps2.setString(1, Double.toString(bonus_total_xp));
                                ps2.setString(2, GroupMemController.getM3());
                                ...
                                sql3 = "SELECT `total_XP` FROM `user` WHERE `users` = ?";
                                ps3 = con.prepareStatement(sql3);
                                ps3.setString(1, GroupMemController.getM3());
                                ...
                                ps4 = con.prepareStatement(sql4);
                                ps4.setString(1, Double.toString(new_total_xp));
                                ps4.setString(2, GroupMemController.getM3());
                               ...
                               if (GroupMemController.getM4() != null) {
                                sql = "SELECT `bonus_xp` FROM `user` WHERE `users` = ?";
                                ps1 = con.prepareStatement(sql);
                                ps1.setString(1, GroupMemController.getM4());
                                ...
                                ps2 = con.prepareStatement(sql2);
                                ps2.setString(1, Double.toString(bonus_total_xp));
                                ps2.setString(2, GroupMemController.getM4());
                                ...
                                sql3 = "SELECT `total_XP` FROM `user` WHERE `users` = ?";
                                ps3 = con.prepareStatement(sql3);
                                ps3.setString(1, GroupMemController.getM4());
                                ...
                                ps4 = con.prepareStatement(sql4);
                                ps4.setString(1, Double.toString(new_total_xp));
                                ps4.setString(2, GroupMemController.getM4());
